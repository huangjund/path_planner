#ifndef _HYBRID_A_STAR_PATH_H
#define _HYBRID_A_STAR_PATH_H
...
class Path {
 public:
  ...
  /*!
     ...
     \param i a parameter for counting the number of nodes
  */
  void updatePath(std::vector<Common::SE2StatePtr> nodePath);
  /*!
     \brief Adds a segment to the path
     \param node a 3D node
  */
  void addSegment(const Common::SE2StatePtr& node);
  /*!
     \brief Adds a node to the path
     \param node a 3D node
     \param i a parameter for counting the number of nodes
  */
  void addNode(const Common::SE2StatePtr& node, int i);
  /*!
     \brief Adds a vehicle shape to the path
     \param node a 3D node
     \param i a parameter for counting the number of nodes
  */
  void addVehicle(const Common::SE2StatePtr& node, int i);
